...
OUTPUT_DIR = Path(
    r"C:\Users\laura\OneDrive\Documenti\UNIVCA\TERZO ANNO\TIROCINIO\MP-IDB-The-Malaria-Parasite-Image-Database-for-Image-Processing-and-Analysis\results\features\vit_b16"
)
...
#MODELLO
def build_vit_b16_feature_extractor(device):
...
def main():
    ...
    model = build_vit_b16_feature_extractor(DEVICE)
