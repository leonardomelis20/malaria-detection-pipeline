...
OUTPUT_DIR = Path(
    r"C:\Users\laura\OneDrive\Documenti\UNIVCA\TERZO ANNO\TIROCINIO\MP-IDB-The-Malaria-Parasite-Image-Database-for-Image-Processing-and-Analysis\results\features\dinobloom_base"
)
...
#MODELLO
def build_dinobloom_feature_extractor(device):
...
def main():
    print("Device:", DEVICE)
    transform = get_dinobloom_transform()
    model = build_dinobloom_feature_extractor(DEVICE)
