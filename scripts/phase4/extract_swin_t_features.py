...
OUTPUT_DIR = Path(
    r"C:\Users\laura\OneDrive\Documenti\UNIVCA\TERZO ANNO\TIROCINIO\MP-IDB-The-Malaria-Parasite-Image-Database-for-Image-Processing-and-Analysis\results\features\swin_t"
)
...
#MODELLO
def build_swin_t_feature_extractor(device):
...
def main():
    print("Device:", DEVICE)
    transform = get_swin_transform()
    model = build_swin_t_feature_extractor(DEVICE)
