...
H5_PATH = Path(
    r"C:\Users\laura\OneDrive\Documenti\UNIVCA\TERZO ANNO\TIROCINIO\MP-IDB-The-Malaria-Parasite-Image-Database-for-Image-Processing-and-Analysis\results\features\resnet50\fold1\train.h5"
)
...
def inspect_h5(h5_path):
    ...
    with h5py.File(h5_path, "r") as h5f:
        ...
        assert features.shape[1] == 2048, f"Errore: feature dim = {features.shape[1]}, atteso 2048"
