...
OUTPUT_DIR = Path(
    r"C:\Users\laura\OneDrive\Documenti\UNIVCA\TERZO ANNO\TIROCINIO\MP-IDB-The-Malaria-Parasite-Image-Database-for-Image-Processing-and-Analysis\results\features\convnext_tiny"
)
...
#MODELLO
def build_convnext_tiny_feature_extractor(device):
...
def main():
    print("Device:", DEVICE)
    transform = get_convnext_transform()
