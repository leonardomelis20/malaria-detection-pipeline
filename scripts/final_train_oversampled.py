...
TRAIN_CSV = r"C:\Users\laura\OneDrive\Documenti\UNIVCA\TERZO ANNO\TIROCINIO\MP-IDB-The-Malaria-Parasite-Image-Database-for-Image-Processing-and-Analysis\csvs\splits_heldout\trainval_metadata_oversampled.csv"
...
result_dir = r"C:\Users\laura\OneDrive\Documenti\UNIVCA\TERZO ANNO\TIROCINIO\results\final_train_oversampled_heldout"
...
train_transform = get_train_trans_oversampling()  
...
history_df.to_csv(os.path.join(result_dir, "final_train_oversampled_history.csv"), index=False)

checkpoint_path = os.path.join(result_dir, "final_model_oversampled_heldout.pth")
