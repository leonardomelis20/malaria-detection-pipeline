...
KFOLD_DIR = r"C:\Users\laura\OneDrive\Documenti\UNIVCA\TERZO ANNO\TIROCINIO\MP-IDB-The-Malaria-Parasite-Image-Database-for-Image-Processing-and-Analysis\csvs\oversampled_folds"
...
result_dir = os.path.join("results", "heldout_5fold_geocolor")
...
#for fold in range(1, N_FOLDS+1):
    ...
    VAL_CSV = os.path.join(KFOLD_DIR, f"fold_{fold}_val.csv")


    
    train_transforms = get_train_trans_geo_color_light()
